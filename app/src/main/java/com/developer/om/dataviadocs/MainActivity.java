package com.developer.om.dataviadocs;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String URL="https://docs.google.com/forms/d/e/1FAIpQLSe3aLJiB-yOVY0MH9BaspUJrVzOvxwRpV-8cMZYmKyrqV7KnQ/formResponse";
    //input element ids found from the live form page
    public static final String EMAIL_KEY="entry.1963932379";
    public static final String SUBJECT_KEY="entry.1935810399";
    public static final String MESSAGE_KEY="entry.934039290";
    ...
    private class PostDataTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result){
            ...
            Toast.makeText(context,result?"idea successfully sent!":"There was some error in sending message. Please try again after some time.",Toast.LENGTH_LONG).show();
        }
